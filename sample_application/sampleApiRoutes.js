...
var optimalApiClient_threed = require("../lib/OptimalApiClient");
var optimalApiClient_ach = require("../lib/OptimalApiClient");
var optimalApiClient_eft = require("../lib/OptimalApiClient");
var optimalApiClient_sepa = require("../lib/OptimalApiClient");
var optimalApiClient_bacs = require("../lib/OptimalApiClient");
...
var optimalApiClient_ach = new optimalApiClient_ach(config.optimalApiKeyId,
		config.optimalApiKeySecret, config.optimalEnvironment,
		config.achAccountNumber);

var optimalApiClient_sepa = new optimalApiClient_sepa(config.optimalApiKeyId,
		config.optimalApiKeySecret, config.optimalEnvironment,
		config.sepaAccountNumber);

var optimalApiClient_bacs = new optimalApiClient_bacs(config.optimalApiKeyId,
		config.optimalApiKeySecret, config.optimalEnvironment,
		config.bacsAccountNumber);

var optimalApiClient_eft = new optimalApiClient_eft(config.optimalApiKeyId,
		config.optimalApiKeySecret, config.optimalEnvironment,
		config.eftAccountNumber);

var optimalApiClient_threed = new optimalApiClient_threed(config.optimalApiKeyId_threeD,
		config.optimalApiKeySecret_threeD, config.optimalEnvironment_threeD,
		config.optimalAccountNumber_threeD);
...
exports.createACHBankAccount = function(req, res) {
	var achbankAccountNumber = randomFixedInteger(6);
	var json = req.query;
	var profile = new optimalApiClient_ach.Profiles();
	var achbankAccount = new optimalApiClient_ach.ACHBankAccounts();
	var address = new optimalApiClient_ach.Address();
	profile.setId(json.profileId);
	...
	optimalApiClient_ach.CustomerServiceHandler(optimalApiClient_ach)
...
exports.createEFTBankAccount = function(req, res) {
	...
	var eftbankAccount = new optimalApiClient.EFTBankAccounts();
	var address = new optimalApiClient.Address();
	profile.setId(json.profileId);
...
exports.createSEPABankAccount = function(req, res) {
	var json = req.query;
	var profile = new optimalApiClient.Profiles();
	var sepabankAccount = new optimalApiClient.SEPABankAccounts();
	var address = new optimalApiClient.Address();
	profile.setId(json.profileId);
...
exports.submitEnrollmentLookup = function(req, res){
	merchantRefNumber = Math.random().toString(36).slice(2);
	var json = req.query;
	var enrollment = new optimalApiClient_threed.Enrollmentchecks();
	var card = new optimalApiClient_threed.Card();
	var cardexpiry = new optimalApiClient_threed.CardExpiry();
	...
	optimalApiClient_threed.ThreeDsecureServiceHandler(optimalApiClient_threed)
...
exports.submitAuthenticationRequest = function(req, res){
	...
	var card = new optimalApiClient_threed.Card();
	var cardexpiry = new optimalApiClient_threed.CardExpiry();
	var authentication = new optimalApiClient_threed.authentication();
...
exports.processACHpurchase = function(req, res){
	var merchantRefNumber = Math.random().toString(36).slice(2);
	var purchase = new optimalApiClient_ach.Purchases();
	var profile = new optimalApiClient_ach.Profiles();
	var achbankAccount = new optimalApiClient_ach.ACHBankAccounts();
	var billingDetails = new optimalApiClient_ach.BillingDetails();
	...
	optimalApiClient_ach.DirectDebitServiceHandler(optimalApiClient_ach)
...
exports.processEFTpurchase = function(req, res){
	var merchantRefNumber = Math.random().toString(36).slice(2);
	var purchase = new optimalApiClient_eft.Purchases();
	var profile = new optimalApiClient_eft.Profiles();
	var eftbankAccount = new optimalApiClient_eft.EFTBankAccounts();
	var billingDetails = new optimalApiClient_eft.BillingDetails();
	...
	optimalApiClient_eft.DirectDebitServiceHandler(optimalApiClient_eft)
...
exports.processSEPApurchase = function(req, res){
	var merchantRefNumber = Math.random().toString(36).slice(2);
	var purchase = new optimalApiClient_sepa.Purchases();
	var profile = new optimalApiClient_sepa.Profiles();
	var sepabankAccount = new optimalApiClient_sepa.SEPABankAccounts();
	var billingDetails = new optimalApiClient_sepa.BillingDetails();
	...
	optimalApiClient_sepa.DirectDebitServiceHandler(optimalApiClient_sepa)
...
exports.processBACSpurchase = function(req, res){
	var merchantRefNumber = Math.random().toString(36).slice(2);
	var purchase = new optimalApiClient_bacs.Purchases();
	var profile = new optimalApiClient_bacs.Profiles();
	var bacsbankAccount = new optimalApiClient_bacs.BACSBankAccounts();
	
	var billingDetails = new optimalApiClient_bacs.BillingDetails();
	...
	optimalApiClient_bacs.DirectDebitServiceHandler(optimalApiClient_bacs)
...
exports.processACHstandaloneCredit = function(req, res){
	var merchantRefNumber = Math.random().toString(36).slice(2);
	var standalonecredits = new optimalApiClient_ach.Standalonecredits();
	var profile = new optimalApiClient_ach.Profiles();
	var achbankAccount = new optimalApiClient_ach.ACHBankAccounts();
	var billingDetails = new optimalApiClient_ach.BillingDetails();
...
exports.processEFTstandaloneCredit = function(req, res){
	var merchantRefNumber = Math.random().toString(36).slice(2);
	var standalonecredits = new optimalApiClient_eft.Standalonecredits();
	var profile = new optimalApiClient_eft.Profiles();
	var eftbankAccount = new optimalApiClient_eft.EFTBankAccounts();
	var billingDetails = new optimalApiClient_eft.BillingDetails();
...
exports.processBACSstandaloneCredit = function(req, res){
	var standalonecredits = new optimalApiClient_bacs.Standalonecredits();
	var profile = new optimalApiClient_bacs.Profiles();
	var bacsbankAccount = new optimalApiClient_bacs.BACSBankAccounts();
	var merchantRefNumber = Math.random().toString(36).slice(2);
	var billingDetails = new optimalApiClient_bacs.BillingDetails();
